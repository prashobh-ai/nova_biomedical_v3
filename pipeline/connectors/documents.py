...
DOMAIN_MAP = {
    "fda_files": ("FDA Clearance Documents", "Regulatory"),
    "fda_regulatory": ("FDA Clearance Documents", "Regulatory"),
    "product_manuals": ("Nova Product Manual Library", "Product Documentation"),
}
DEFAULT_DOMAIN = ("Nova Product Manual Library", "Product Documentation")
