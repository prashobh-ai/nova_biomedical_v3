...
@pytest.fixture
def docs_source_dir():
    return Path(__file__).resolve().parent.parent / "knowledge_fabric"
...
# =============================================================================
# End-to-end: build full index from knowledge_fabric
# =============================================================================
def test_full_pipeline_emits_valid_index(tmp_path, docs_source_dir):
    ...
    fda = pathlib.Path("knowledge_fabric/fda_files/structured")
    index = build(docs_source_dir, fda, out, sem,
                  pathlib.Path("knowledge_fabric/youtube"))
...
def test_fda_connector_verbalises_structured_records():
    ...
    root = pathlib.Path("knowledge_fabric/fda_files/structured")
    if not root.exists():
